...
public class AutonomousCommandAlt extends CommandBase {
   ...
   */
  public AutonomousCommandAlt(DriveTrain drivetrain, Shooter shooter, ConveyorBelt conveyorbelt) {
    m_drive = drivetrain;
    m_shooter = shooter;
    m_belt = conveyorbelt;
